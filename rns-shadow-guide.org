...
#+MACRO: R1i {{{i(Firststrike-Bracelet)}}} {{{i(Garnet-Staff)}}}(\rightarrow {{{i(Obsidian-Hairpin)}}})
...
#+MACRO: E3i {{{n3i}}} {{{i(Hawkfeather-Fan)}}}(\rightarrow {{{i(Redwhite-Ribbon)}}}) {{{i(Sacred-Bow)}}} {{{i(Shrinemaidens-Kosode)}}} {{{i(Mermaid-Scalemail)}}} {{{i(Firescale-Corset)}}}
